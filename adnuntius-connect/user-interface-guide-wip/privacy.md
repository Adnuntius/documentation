...
1. Header text.
2. Explanatory text where you can inform your visitors.
...
The non-numbered input fields are for other parts of the consent box that appear if you interact with it, for instance to obtain more information.
