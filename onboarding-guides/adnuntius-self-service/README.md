...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A "domain name". Your self-service portal will be placed under a URL such as the example on the left, so please send us your preferred name, before [following these instructions](../../other-useful-information/whitelabeling.md#self-service-portal).                                     | <p>https://bookings.adnuntius.com/yourname/</p><p>or bookings.yourdomain.com</p>                                                                                                                           |
...
![The Adnuntius logo on the top left will be replaced by your own logo.](<../../.gitbook/assets/top-menu-bar-logo (1).png>)
