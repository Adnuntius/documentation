...
**Ad server data export** lets you export raw data to your own database so that you can connect your data to for instance business intelligence or analytics tools. You can also use one of our integrated [data exports](../../../adnuntius-data/user-interface-guide/admin/data-exports.md). To read more about what we can do for you, please see [this blog post](https://adnuntius.com/blog/adnuntius-brings-the-big-data). To get this enabled, please contact [support@adnuntius.com](mailto:support@adnuntius.com).
