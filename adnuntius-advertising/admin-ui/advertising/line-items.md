...
{% hint style="info" %}
Please note that in order for companion creatives, creative delivery and exclusion labels to work, ad units must be deployed to the publisher's page according to the [Multi adn.request Calls](../../requesting-ads/intro/adn-request.md) guidelines.
{% endhint %}
